...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="formValidate" id="formValidate" method="post" action="process.php" novalidate="novalidate" class="col s12">
        <div class="row">
          <div class="input-field col s12 center">
            <h5><i><b>Register To Easy Meal System</b> </i></h5>
            <h6 class="center">Join us now!</h6>
          </div>
        </div>
